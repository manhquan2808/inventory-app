...
class AddProduction extends Controller
{
    public function showAddProduction()
    {
        return view('admin.addProduction.index', [
            'inventory' => Inventory::whereNotIn('inventory_id', [5])
                ->get()
        ]);
    }
    ...
    public function addProduction(Request $request)
    {
        ...
        if ($authEmail['deliverability'] === "DELIVERABLE") {
            ...
            try {
                ...
                return redirect('/admin/addProduction');
            }
